# login
Триггер **login** срабатывает, когда игрок входит в игру ou телепортируется.

## Notas
Утверждение &laquo;срабатывает при входе в игру&raquo; не совсем корректно. На самом деле, триггер срабатывает по завершении окна загрузки персонажа, будь então телепортация ou первый вход в игру.
